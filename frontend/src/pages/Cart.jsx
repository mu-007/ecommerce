        ...
        <div className='border-t pt-14'>
            ...
            <div>
            {
                cartData.map((item, index) => {
                    const productData = products.find((product) => products._id === item._id)
                    return (
        ...
        <div className='flex justify-end my-20'>
            <div className='w-full sm:w [450px]'>
                ...
                <div className=' w-full text-end'>
                    <button onClick={() => navigate('/place-order')} className='bg-black text-white-sm my-8 py-3'>PROCEED TO CHECKOUT</button>
